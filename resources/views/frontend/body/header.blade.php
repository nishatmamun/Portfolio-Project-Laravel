                    ...
                    <div class="menu__wrap">
                        <nav class="menu__nav">
                            ...
                            <div class="navbar__wrap main__menu d-none d-xl-flex">
                                <ul class="navigation">
                                    <li class="{{ ($route == 'home.main') ? 'active' : '' }}"><a
                                            href="{{ route('home.main') }}">Home</a></li>
                                    <li class="{{ ($route == 'home.about') ? 'active' : '' }}"><a
                                            href="{{ route('home.about')}}">About</a></li>
                                    <li class="{{ ($route == 'home.service') ? 'active' : '' }}"><a
                                            href="services-details.html">Services</a></li>
                                    <li
                                        class="menu-item-has-children {{ ($route == 'home.portfolio') ? 'active' : '' }}">
                                        <a href="{{ route('home.portfolio') }}">Portfolio</a>
                                    </li>
                                    <li class="menu-item-has-children {{ ($route == 'home.blog') ? 'active' : '' }}">
