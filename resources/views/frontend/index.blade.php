            ...
            <div class="col-lg-6">
                <div class="partner__content">
                    <div class="section__title">
                        ...
                        <h2 class="title">I proud to have collaborated with some awesome
                            companies</h2>
                    </div>
                    <p>I'm a bit of a digital product junky. Over the years, I've used
                        hundreds of web and
                        mobile apps in different industries and verticals. Eventually, I
